...
trait ViewsBulkOperationsFormTrait {
   ...
   */
  public static function calculateEntityBulkFormKey(EntityInterface $entity, $base_field_value, $radio_choice) {
  ...
  protected function getListItem($bulkFormKey, $label) {
    ...
    $item[] = $label; // #radio: note, there is now one more option before this one
    return $item;
  }
